...
- Create Angular project with ng: `ng new thesis_luab558.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`thesis_luab558.client.esproj`).
